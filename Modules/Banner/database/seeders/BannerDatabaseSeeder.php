    ...
    public function run()
    {
        ...
        \DB::table('banners')->insert(array (
            ...
            array (
                'id' => 3,
                'title' => NULL,
                'file_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/the_gunfighters_redemption_poster.png',
                'poster_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/the_gunfighters_redemption_thumb.webp',
                'type' => 'movie',
                'type_id' => '23',
                ...
                'deleted_at' => NULL,
                'banner_for' => 'movie',
                'poster_tv_url' => 'http://127.0.0.1:8000/default-image/Default-Image.jpg',
            ),
            3 => 
            array (
                'id' => 4,
                'title' => NULL,
                'file_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/daizys_enchanted_journey_poster.png',
                'poster_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/daizys_enchanted_journey_thumb.webp',
                'type' => 'movie',
                'type_id' => '24',
            ...
            array (
                'id' => 6,
                'title' => NULL,
                'file_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/the_power_of_words_this_story_will_change_your_life.png',
                'poster_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/the_power_of_words_this_story_will_change_your_life.png',
                'type' => 'video',
                'type_id' => '20',
                ...
                'deleted_at' => NULL,
                'banner_for' => 'video',
                'poster_tv_url' => 'http://127.0.0.1:8000/storage/streamit-laravel/the_power_of_words_this_story_will_change_your_life.png',
            ),
            6 => 
            array (
                'id' => 7,
