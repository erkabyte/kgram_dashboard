    ...
    public function run()
    {
        ...
        $videos = [
            [
                ...
                'trailer_url' => 'https://youtu.be/2FYNbA6bf0c?si=IzWsnwAhjnxcd1C1',
                'access' => 'free',
                'IMDb_rating' => NULL,
                'content_rating' => NULL,
                'duration' => Null,
            ...
            [
                'name' => 'Seize Your Life - Powerful Motivational Speech',
                'poster_url' => '/dummy-images/video/seize_your_life.png',
                'poster_tv_url' => '/dummy-images/video/seize_your_life.png',
                'trailer_url_type' => 'YouTube',
                'trailer_url' => null,
                'access' => 'paid',
                'plan_id' => 1,
                ...
                'is_restricted' => 0,
                'short_desc' => 'Seize Your Life is a compelling motivational speech that inspires you to take control and live your life to the fullest. 🚀🌟',
                'description' => 'In Seize Your Life - Powerful Motivational Speech, discover the keys to unlocking your potential and embracing every moment with purpose and passion. This uplifting speech is packed with powerful insights and practical advice that will motivate you to overcome obstacles, chase your dreams, and seize every opportunity that life presents. Whether you\'re looking for a boost in your personal or professional life, "Seize Your Life" provides the inspiration you need to take action and make the most of your journey. 🚀🌟',
                'enable_quality' => 0,
                'video_upload_type' => 'YouTube',
            ...
            [
                'name' => 'Serenity of Nature',
                'poster_url' => '/dummy-images/video/serenity_of_nature.png',
                'poster_tv_url' => '/dummy-images/video/serenity_of_nature.png',
                'trailer_url_type' => 'YouTube',
                'trailer_url' => null,
                'access' => 'free',
                'IMDb_rating' => NULL,
                ...
                'is_restricted' => 0,
                'short_desc' => 'Serenity of Nature is a breathtaking short video capturing the tranquil beauty of the natural world. 🌿🌅',
            ...
            [
                'name' => 'Cityscape Escapade',
                'poster_url' => '/dummy-images/video/cityscape_escapade.png',
                'poster_tv_url' => '/dummy-images/video/cityscape_escapade.png',
                'trailer_url_type' => 'YouTube',
                'trailer_url' => null,
                'access' => 'free',
                'IMDb_rating' => NULL,
            ...
            [
                'name' => 'Victory Vibes',
                'poster_url' => '/dummy-images/video/victory_vibes.png',
                'poster_tv_url' => '/dummy-images/video/victory_vibes.png',
                'trailer_url_type' => 'YouTube',
                'trailer_url' => null,
                'access' => 'free',
                'IMDb_rating' => NULL,
            ...
            [
                'name' => 'Yoga for Beginners: Start Here',
                'poster_url' => '/dummy-images/video/yoga_for_beginners_start_here.png',
                'poster_tv_url' => '/dummy-images/video/yoga_for_beginners_start_here.png',
                'trailer_url_type' => 'YouTube',
                'trailer_url' => null,
                'access' => 'paid',
                'plan_id' => 3,
        ...
        if (env('IS_DUMMY_DATA')) {
            foreach ($videos as $key => $video_data) {
                ...
                $video = Video::create(Arr::except($video_data, ['poster_url','poster_tv_url']));

                if (isset($posterPath)) {
                    $posterUrl = $this->uploadToSpaces($posterPath);

                    if ($posterUrl) {
                        $video->poster_url = extractFileNameFromUrl($posterUrl);
                    }
                }
                if (isset($posterTvPath)) {
                    $posterTvUrl = $this->uploadToSpaces($posterTvPath);
                    if ($posterTvUrl) {
                        $video->poster_tv_url = extractFileNameFromUrl($posterTvUrl);
                    }
                }
                $video->save();
            }
