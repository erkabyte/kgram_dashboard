...
<body>
  ...
  <div class="header">
    <div class="main-logo" style="float: left">
        ...
        <img class="logo-mini img-fluid" src="{{   $logo }}" height="30" alt="logo">
    </div>
  ...
  <table>
    ...
    <tbody>
        ...
        @php
        // Initialize amount_after_discount with the original amount
        $amount_after_discount = $data->amount;

        // If there's a discount, update the amount_after_discount
