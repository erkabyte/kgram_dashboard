    ...
    public function run()
        {
            ...
            $episodes = [
                ...
                [
                    ...
                    'is_restricted' => false,
                    'video_upload_type' => 'YouTube',
                    'video_url_input' => 'https://youtu.be/JFDSMSOa0P4?si=xdYDox4P99E_B71Q',
                    'download_status' => false,
                    'download_type' => null,
                    'download_url' => null,
                    'enable_download_quality' => false,
                ...
                [
                    ...
                    'is_restricted' => false,
                    'video_upload_type' => 'YouTube',
                    'video_url_input' => 'https://youtu.be/uMCs-4O8y8I?si=rninR127B_8Fp_zM',
                    'download_status' => false,
                    'download_type' => null,
                    'download_url' => null,
                    'enable_download_quality' => false,
                ...
                [
                    ...
                    'is_restricted' => false,
                    'video_upload_type' => 'YouTube',
                    'video_url_input' => 'https://youtu.be/j28rVk7MZyM?si=m8zVw40o9wFm5tqL',
                    'download_status' => false,
                    'download_type' => null,
                    'download_url' => null,
                    'enable_download_quality' => false,
            ...
            if (env('IS_DUMMY_DATA')) {
                foreach ($episodes as $mediaData) {
                    ...
                    if (isset($posterTvPath)) {
                        ...
                        if ($posterTvUrl) {
                            $media->poster_tv_url = extractFileNameFromUrl($posterTvUrl);
                        }
                    }
